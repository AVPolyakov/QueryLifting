...
namespace QueryLifting
{
    public abstract class Choice<T1, T2>
    {
        ...
        public sealed class Choice1 : Choice<T1, T2>
        {
            ...
            public override T Match<T>(Func<T1, T> choice1, Func<T2, T> choice2)
            {
    ...
    {
        public static Choice<T1, T2> New<T1, T2>(T1 choice1, Option<T2> choice2)
        {
            return choice1;
        }

        public static Choice<T1, T2> New<T1, T2>(Option<T1> choice1, T2 choice2)
        {
            return choice2;
        }
    }
